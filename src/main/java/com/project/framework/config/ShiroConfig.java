...
//        filterChainDefinitionMap.put("/tool/gen/**","anon");
        ...
        filterChainDefinitionMap.put("/gift/accountNumberController/**","anon");
        filterChainDefinitionMap.put("/gift/giftMachine/**","anon");
        filterChainDefinitionMap.put("/gift/commonInterface/**","anon");
