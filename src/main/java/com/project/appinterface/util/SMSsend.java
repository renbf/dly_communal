...
//		private static final long serialVersionUID = 1L;
	...
	public static boolean SMSSend(String phone,String SMSCode) throws ClientException{
		...
		//替换成你的AK
		final String accessKeyId = "LTAI0xotkIQ0uZVW";//你的accessKeyId,参考本文档步骤2
		final String accessKeySecret = "WD7i1iznbmkrAM2dP6Or8o9A2cXVu8";//你的accessKeySecret，参考本文档步骤2
		...
		//必填:短信签名-可在短信控制台中找到
		request.setSignName("大来也");
		//必填:短信模板-可在短信控制台中找到
		request.setTemplateCode("SMS_139545030");
